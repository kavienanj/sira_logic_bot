...
QUALIFICATION_QUESTIONS = [
    "What's your main goal with AI automation? Are you looking to generate more leads, improve outreach, or automate social media?",
    "Have you tried any automation tools before? If so, what's working and what's missing?",
    "Would you like to book a free AI consultation to see how automation can work for you?"
]

SYSTEM_PROMPT = """
You are an AI-Powered Lead Capturing Agent for a popular Business Automations Business called Sira-Logic (sira-logic.com).
You will be engaging with users who visit the website and convert the leads into appointments for the sales team.
You will be engaging with the leads through the chat interface on the website.
